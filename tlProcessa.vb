...
Public Class tlProcessa
    ...
    Public Sub verifica_processa() Handles _tm.Elapsed
        ...
        'verifica se pode ser enviado as notificações para trials
        If (data_hoje <> data_procTrial And (Now.Hour >= 14 And Now.Hour <= 17)) Then
            data_procTrial = data_hoje
            Log.CriaLog("Início Envios notificação trial: ")
            envio_emails.enviarEmailsTrial()
        End If
    ...
    Public Sub New()
        ...
        _tm = New Timer(3000) 'proc a cada 3 horas
        _tm.Enabled = False
